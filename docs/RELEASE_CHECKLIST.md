...
- [x] The application version, planned release tag and frontend asset versions agree.
...
- [x] Run verified restore and recoverable uninstall/reinstall on a real NAS; confirm database, backups, media roots and named volumes persist.
